...
def process_image_path(annotation_val):
    ...
    return image_path
class MetaVQAMultiviewMixMultiFrameCriticalDataset(VQADataset):
    def __init__(self, vis_processor=None, text_processor=None, vis_root=None, ann_paths=None):
        ...
        print("Critical dataset: The number of Training data: ", len(self.questions))
    def init_metavqa(self, ann_paths):
        ...
        sample_numbers = [500, 500, 250, 250]
        # sample_number = 2000
        # sample_number = 5
...
class MetaVQAMultiviewMixMultiFrameCriticalEvalDataset(VQADataset):
    def __init__(self, vis_processor=None, text_processor=None, vis_root=None, ann_paths=None):
        """
        vis_root (string): Root directory of images (e.g. coco/images/)
        ann_root (string): directory to store the annotation file
    ...
    def init_metavqa(self, ann_paths):
        ...
        sample_numbers = [250, 250, 125, 125]
        # sample_number = 2000
        # sample_number = 5
        for ann_path, sample_number in zip(ann_paths,sample_numbers):
            print("Load from: " + ann_path)
    ...
    def load_and_process_images(self, images_paths):
        ...
        # If t is 1, repeat the tensor 20 times along the first dimension
        if t == 1:
            processed_images_tensor = processed_images_tensor.repeatso(5, 1, 1, 1, 1)
