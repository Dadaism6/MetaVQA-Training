...
def process_image_path(annotation_val):
    ...
    return image_path
class EvalMetaVQAMultiviewMixMultiFrameCriticalDataset(VQADataset):
    def __init__(self, vis_processor=None, text_processor=None, vis_root=None, ann_paths=None):
        ...
        print("Eval Critical dataset: The number of Training data: ", len(self.questions))
...
class EvalMetaVQAMultiviewMixMultiFrameCriticalEvalDataset(VQADataset):
    def __init__(self, vis_processor=None, text_processor=None, vis_root=None, ann_paths=None):
        """
        vis_root (string): Root directory of images (e.g. coco/images/)
        ann_root (string): directory to store the annotation file
        ...
        self.init_metavqa(ann_paths)
        print("Eval Critical:The number of Validation data: ", len(self.questions))
    def init_metavqa(self, ann_paths):
        ...
        ann_paths = ["/path/to/your/local/drive/metavqa_final/vqa/testing/safety_critical_processed/CAT"]
        sample_numbers = [100]
        for ann_path, sample_number in zip(ann_paths,sample_numbers):
            print("Load from: " + ann_path)
            print("Current Num: " + str(len(self.questions)))
