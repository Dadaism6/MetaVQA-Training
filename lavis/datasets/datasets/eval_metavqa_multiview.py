...
def process_image_path(annotation_val):
    ...
    return image_path
class EvalMetaVQAMultiviewDataset(VQADataset):
    def __init__(self, vis_processor=None, text_processor=None, vis_root=None, ann_paths=None):
        ...
        print("single frame dataset: The number of Training in data: ", len(self.questions))
    def init_metavqa(self, ann_paths):
        ann_paths = ["/path/to/your/local/drive/metavqa_final/vqa/training/single_frame_processed/Waymo/"]
        sample_number = 1
        # sample_number = 5
...
class EvalMetaVQAMultiviewEvalDataset(VQADataset):
    def __init__(self, vis_processor=None, text_processor=None, vis_root=None, ann_paths=None):
        """
        vis_root (string): Root directory of images (e.g. coco/images/)
        ann_root (string): directory to store the annotation file
        ...
        self.init_metavqa(ann_paths)
        print("Single Frame: The number of Validation data: ", len(self.questions))
    def init_metavqa(self, ann_paths):
        ann_paths = ["/path/to/your/local/drive/metavqa_final/vqa/validation/single_frame_processed/Waymo"]
        sample_number = 200
        # sample_number = 5
        for ann_path in ann_paths:
            # list files in ann path
